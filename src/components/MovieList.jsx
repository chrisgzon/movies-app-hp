...
const MovieList = ({ movies, countResultsTotal, fetchMoviesByPage, currentPage }) => {
        ...
        <>
            ...
            <MDBPagination className='mb-4 pagination'>
                <MDBPaginationItem disabled={currentPage === 1}>
                    <MDBPaginationLink onClick={() => fetchMoviesByPage(currentPage - 1)} tabIndex={-1} aria-disabled="true">
                        Anterior
                    </MDBPaginationLink>
                </MDBPaginationItem>
